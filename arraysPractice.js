...
function finder() {
  ...
  for (var i = 0; i < numbers.length; i++) {
    ...
    else if (i === numbers.length - 1 && numbers[i] !== random) {
      console.log(false);
    }
  }
}
...
function fillArray(devMountainEmployees, tyler, cahlan, ryan, colt) {
  devMountainEmployees.push(tyler, cahlan, ryan, colt);
  console.log(devMountainEmployees);
  console.log(devMountainEmployees.length);
}

fillArray(devMountainEmployees, tyler, cahlan, ryan, colt);

/*Now let's say Cahlan has a mental breakdown and has to take a leave of absence to 'find himself'.
Loop through your devMountainEmployees until you find cahlan, then remove him from the array.*/

function removeEmployee(devMountainEmployees, personToRemove) {
    index = devMountainEmployees.indexOf(personToRemove);
